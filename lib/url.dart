...
//                 displayText =
//                 "📞 Call ended (${duration}s, ${direction == "incoming" ? "in" : "out"})";
//                 break;
//               case "canceled":
...
//           if (data["action"] == "new_message") {
//             final chatMatch = data["chat_id"] == null ||
//                 data["chat_id"].toString() == widget.chatId.toString();
//             if (!chatMatch) return;
//
//             // 🔹 Avoid duplicates (same ID already exists)
//             final msgId = data["id"];
//             final already = provider.messages
//                 .any((m) => m["id"] != null && m["id"] == msgId);
//             if (already) return;
//
//             final mediaType = data["media_type"] ?? "text";
//             final mediaUrl = data["media_link"];
...
//             });
//
//             debugPrint("✅ New message added: $mediaType $text $mediaUrl");
//
//             provider.notifyListeners();
//             return;
//           }
...
//             if (mounted) setState(() => _uploadProgress = 100.0);
//             if (_uploadingMsgIndex != null &&
//                 _uploadingMsgIndex! < provider.messages.length) {
//               provider.messages[_uploadingMsgIndex!]["uploading"] = false;
//               provider.messages[_uploadingMsgIndex!]["progress"] = 100.0;
...
//         }
//       }, onDone: () {
//         debugPrint("⚠️ WS closed. Reconnecting in 3s...");
//         Future.delayed(const Duration(seconds: 3), _connectWebSocket);
//       }, onError: (err) {
...
//       });
//     } catch (e) {
//       debugPrint("⚠️ WS connect fail: $e");
//       Future.delayed(const Duration(seconds: 5), _connectWebSocket);
//     }
//   }
//
